...
The structure of this paper is as follows: @sec-data explains the dataset, variable selection, and measurement strategies employed to study marital status. @sec-model discusses the logistic regression methodology, including model rationale, prior specifications, and validation processes. @sec-results presents the key findings with supporting visualizations, emphasizing the roles of education, income, race, gender, and age in predicting non-marriage. Finally, @sec-discussion discusses the implications of the findings, acknowledges study limitations, and outlines potential areas for future research.
...
## Analysis of Education, Income, and Marriage Patterns
